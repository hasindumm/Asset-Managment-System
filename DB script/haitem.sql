...
CREATE TABLE `product1` (
  ...
  `item_type` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
  `person_in_charge` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
  `section` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
  `quntity` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
