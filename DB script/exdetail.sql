...
DROP TABLE IF EXISTS `product20`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `product20` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fname` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
  `lname` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
  `email` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
  `nic` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
  `address` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
  `contactno` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
